...
try {
  ...
  $mail->Username   = 'tt5yy1@yandex.ru'; // Логин на почте
  $mail->Password   = 'iiksowneukconcwi'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('tt5yy1@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('tt5yy1@yandex.ru');
